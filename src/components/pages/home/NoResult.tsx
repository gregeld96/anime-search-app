    ...
    return (
        ...
        bg-black/5 dark:bg-white/5 py-16 text-center transition-colors">
            ...
            <p className="mt-2 max-w-sm text-sm text-black/60 dark:text-white/60">
                We couldn’t find any anime matching your search criteria.
                Try changing your keywords or clear your search.
            </p>

            <button
                onClick={clearSearch}
                className="mt-6 rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold hover:bg-primary/90 transition-colors"
            >
                Clear Search
            </button>
        </div>
